...
module.exports = function() {
    ...
    let flatUIColors = ['#34495e', '#5900ff', '#9b59b6', '#3498db', '#2ecc71', '#1abc9c', '#f1c40f', '#ecf0f1', '#e67e22', '#e74c3c', '#95a5a6'];
    let counter = 0;
    ...
    const inlineTweets = document.querySelectorAll("*[data-inline-tweet]");
    if (inlineTweets)
